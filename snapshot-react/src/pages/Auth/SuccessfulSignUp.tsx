  ...
  return (
    <section className={styles.signContainer}>
      ...
      <p>
        Вітаємо у
        {' '}
        <strong>SNAPSHOT IT!</strong>
        <br />
        Дякуємо, що приєдналися до нас.
      </p>
      <br />
      <p>
        Для завершення реєстрації, будь ласка, перевірте свою електронну пошту
        {' '}
        і підтвердіть свій акаунт,
        натиснувши на посилання в листі, який ми щойно вам відправили.
      </p>
      <br />
      <p>
