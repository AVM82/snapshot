...
import { addQuestion, getGeminiQuestions, getSkillQuestions } from '../../../../store/reducers/interwiew/actions';
...
function AddQuestion({ onClose,skillId }:AddQuestionProps):React.JSX.Element{
  const { interviewer,  id:interviewId ,currentSkillQuestions,geminiQuestions } =
  ...
  const handleAddQuestion = (e: React.FormEvent<HTMLFormElement>):void=>{
    e.preventDefault();
    dispatch(addQuestion({ interviewId,interviewerId ,skillId ,question:questionText }));
    onClose();
  };
    ...
    <div className={styles.wrapper}>
      ...
      >
        ...
        <div className={styles.formFooter}>
          <button className={styles.submitButton} type="submit">Додати запитання</button>
